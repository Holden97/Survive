...
public class Bug : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (curHealth <= 0)
        {
            ...
            AudioManager.PlayClip(AudioManager.Instance.bugDeathClip);
    ...
    public void ConfirmState()
    {
        ...
        {
            //if (transform.parent != GameObject.Find("EnemyManager").transform){
            //    if (transform.parent.gameObject.GetComponent<BugBase>().BeSurrounded == true)
            //    {
            ...
            //        Direction = moveDirectionList[Random.Range(0, 2)];
            //    }
            //    else
            //    {
            //        bugState = State.idle;
